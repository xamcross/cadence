...
- **2026-06-14** (002-authentication): F01 Authentication & Session Management — OIDC SSO + email/password fallback, revocable JWT-in-cookie session (Mongo registry), invite-only provisioning, password reset, RBAC-role on session (enforcement is F02). App-level AES-256-GCM PII encryption + emailHash; Mongock ChangeUnit002 indexes + TTL. Angular auth core + login/invite/reset/shell. Backend compiles; integration/contract tests authored for US2/US3/US4 (not run locally — Docker/Testcontainers env limitation). 4-role §VI review over 2 loops: 2 BLOCKER + 4 MAJOR found and fixed (partial-index null collision, JWT key selection, reset NPE, token-oracle ordering, CAS expiry race, lockout lost-update). Remaining: SSO/tamper/logout/PII-scan/E2E tests + CI/docs (tasks T036/T037/T043/T045/T046/T058/T059/T064/T065/T066/T069/T071/T073/T074/T075/T076/T078).
