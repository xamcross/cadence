 ...
 * Verifies: Terms + Privacy + product-page + Home links rendered as root-relative full-document anchors
 * using `href` (NOT routerLink - these are static files outside the SPA router), the hrefs use the
 * trailing-slash served form (/terms/ /privacy/ /features/ ... - the no-slash form costs a 308 hop),
 * carry no token/query, a <footer> landmark is present, axe 0 WCAG 2.2 AA violations, and the links
...
describe('PublicFooterComponent (031 US3)', () => {
  ...
  it('renders Home, product, Terms and Privacy links using href (not routerLink) with exact root-relative targets', () => {
